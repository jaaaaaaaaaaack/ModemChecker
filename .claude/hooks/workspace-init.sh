#!/bin/bash
# Claude Code SessionStart hook for ModemChecker workspaces
# Ensures env vars exist and checks if workspace is behind remote main
...
# Fetch latest remote state (quiet, quick timeout)
