  ...
  function TextFieldRoot(
    ...
    return (
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex h-12 w-full flex-none items-center gap-1 rounded-sm border border-solid border-neutral-300 bg-default-background px-2 py-0.5 group-focus-within/be48ca43:border group-focus-within/be48ca43:border-solid group-focus-within/be48ca43:border-brand-primary",
            {
