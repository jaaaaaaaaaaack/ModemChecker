...
/*
 * Documentation:
 * Text Field — https://app.subframe.com/c141bce6134a/library?component=Text+Field_be48ca43-f8e7-4c0e-8870-d219ea11abfe
 */
  ...
  function TextFieldRoot(
    ...
    return (
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex h-12 w-full flex-none items-center gap-1 rounded-sm border border-solid border-neutral-border bg-default-background px-2 py-0.5 group-focus-within/be48ca43:border group-focus-within/be48ca43:border-solid group-focus-within/be48ca43:border-brand-primary",
            {
